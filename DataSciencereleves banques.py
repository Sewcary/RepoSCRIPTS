...
import pandas as pd 
data = pd.read_csv("C:\\Users\\ZT5549\\DataScience\\Statistics\\analyse\\operations.csv", parse_dates=[1,2],sep= ',',
...
data.to_csv("C:\\Users\\ZT5549\\DataScience\\Statistics\\analyse\\operations_enrichies.csv",index=False)
